...
public class DallasController {
    ...
    public void initialize(){
        destinationChoice.setItems(FXCollections.observableArrayList("New York", "Los Angeles", "Houston", "Chicago", "Philadelphia",
                "Phoenix", "San Antonio", "San Diego", "San Jose", "Austin", "Jacksonville", "Forth Worth", "Columbus", "Seattle", "Indianapolis"));
    ...
    public void onPurchaseButton(){
        ...
        if(destinationChoice == null || date == null || destinationChoice.getSelectionModel().isEmpty() || date.isBefore(now) || firstName.getText().isEmpty() ||
            ...
            purchase.setContentText("Departure: Dallas\nDestination: " + selectedChoice + "\nDeparture date: " + date +
