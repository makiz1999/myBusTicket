...
public class HoustonController {
    ...
    public void initialize(){
        destinationChoice.setItems(FXCollections.observableArrayList("New York", "Chicago", "Los Angeles", "Phoenix", "Philadelphia",
    ...
    public void onPurchaseButton(){
        ...
        if(destinationChoice == null || date == null || destinationChoice.getSelectionModel().isEmpty() || date.isBefore(now) || firstName.getText().isEmpty() ||
            ...
            purchase.setContentText("Departure: Houston\nDestination: " + selectedChoice + "\nDeparture date: " + date +
